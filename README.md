...
respawn:addKeybind("Hard Reset", Enum.KeyCode.N, function()
...
respawn:addKeybind("Fast Reset", Enum.KeyCode.L, function()
...
section3:addKeybind("Instant GOD", Enum.KeyCode.U, function()
